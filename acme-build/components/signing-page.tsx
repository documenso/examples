      ...
      <div className="isolate flex min-h-svh items-center justify-center bg-background px-6 py-10">
        <div className="max-w-md space-y-6">
          <div className="space-y-3">
            ...
            <p className="max-w-[48ch] text-base text-pretty text-muted-foreground sm:text-sm">
        ...
        <div className="mx-auto flex min-h-svh max-w-3xl flex-col justify-center gap-10 px-6 py-10">
          ...
          <dl className="grid gap-4 sm:grid-cols-3">
            <div className="border-t border-border pt-4">
              ...
              <dd className="mt-2 text-base font-medium text-foreground sm:text-sm">
                {sub.name}
              </dd>
            </div>
            <div className="border-t border-border pt-4">
              ...
              <dd className="mt-2 text-base font-medium tabular-nums text-foreground sm:text-sm">
          ...
          <aside className="flex flex-col gap-10">
            ...
            <dl className="grid gap-4 border-y border-border py-6">
              <div className="flex items-baseline justify-between gap-4">
                ...
                <dd className="text-base font-medium text-foreground sm:text-sm">
                  {sub.trade}
                </dd>
              </div>
              <div className="flex items-baseline justify-between gap-4">
              ...
              <div className="flex items-baseline justify-between gap-4">
                ...
                <dd className="text-right text-base font-medium text-foreground sm:text-sm">
                  {PROJECT_NAME}
                </dd>
              </div>
            </dl>
            ...
            <div className="rounded-3xl bg-muted/50 p-6">
              <div className="space-y-2">
                ...
                <p className="max-w-[34ch] text-base text-pretty text-muted-foreground sm:text-sm">
              ...
              <div className="mt-5 border-t border-border pt-4">
                ...
                <p className="mt-2 text-base font-medium tabular-nums text-foreground sm:text-sm">
            ...
            {signingToken && !error ? (
              ...
              <div className="flex min-h-[860px] flex-col items-center justify-center gap-6 px-8 text-center lg:min-h-[960px]">
                <div className="space-y-3">
                  ...
                  <p className="max-w-[42ch] text-base text-pretty text-muted-foreground sm:text-sm">
                    {error ??
