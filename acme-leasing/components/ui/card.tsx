...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card flex flex-col gap-5 overflow-hidden rounded-lg border border-border/70 bg-card py-5 text-sm text-card-foreground data-[size=sm]:gap-4 data-[size=sm]:py-4 has-[>img:first-child]:pt-0 *:[img:first-child]:rounded-t-lg *:[img:last-child]:rounded-b-lg",
        className,
      )}
      {...props}
    />
